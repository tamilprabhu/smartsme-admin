...
function Sidebar() {
  ...
  return (
    <div className={`d-flex flex-column flex-shrink-0 p-3 text-bg-dark ${collapsed ? 'sidebar-collapsed' : ''}`} style={{ width: collapsed ? '80px' : '280px', height: '100vh', transition: 'width 0.3s' }}>
      <div className="d-flex align-items-center pb-3 mb-3 border-bottom">
        ...
        <button className="btn btn-sm btn-dark ms-auto" onClick={() => setCollapsed(!collapsed)} title={collapsed ? 'Expand' : 'Collapse'}>
      ...
      <div style={{ overflowY: 'auto', flex: 1 }}>
        <ul className="list-unstyled ps-0">
          <li className="mb-1">
            <button className="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-white w-100" onClick={() => toggleMenu('company')} title="Company">
          ...
          <li className="mb-1">
            <button className="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-white w-100" onClick={() => toggleMenu('production')} title="Production">
          ...
          <li className="mb-1">
            <button className="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-white w-100" onClick={() => toggleMenu('inventory')} title="Inventory">
          ...
          <li className="mb-1">
            <button className="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-white w-100" onClick={() => toggleMenu('account')} title="Account">
      ...
      <div className="border-top pt-3">
        {collapsed ? (
          <button className="btn btn-link text-white p-0" onClick={handleLogout} title="Sign out">
